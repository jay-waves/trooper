...
bool Mutator::MutateSameSize(ByteArray &data) {
  auto mutator = ...
      // {&TrooperMutator::FlipBit, &TrooperMutator::SwapBytes,
      //  &TrooperMutator::ChangeByte,
      //  &TrooperMutator::OverwriteFromDictionary,
      //  &TrooperMutator::OverwriteFromCmpDictionary},
  return (this->*mutator)(data);
}


bool Mutator::MutateIncreaseSize(ByteArray &data) {
  auto mutator = ...
      // {&TrooperMutator::InsertBytes, &TrooperMutator::InsertFromDictionary},
  return (this->*mutator)(data);
}

bool Mutator::MutateDecreaseSize(ByteArray &data) {
  auto mutator = &Mutator::EraseBytes;
  return (this->*mutator)(data);
}
