#ifndef THIRD_PARTY_SHARED_MEMORY_BLOB_SEQUENCE_H_
#define THIRD_PARTY_SHARED_MEMORY_BLOB_SEQUENCE_H_

// shared memory blob sequence
...
#endif  // THIRD_PARTY_SHARED_MEMORY_BLOB_SEQUENCE_H_
